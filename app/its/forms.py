...
from wtforms import StringField, SubmitField, IntegerField, DateTimeField, RadioField, validators,DateField, SelectField, BooleanField
...
class ReportsForm(FlaskForm):
    ...
    time_gmt_s = StringField('S Time')
    time_gmt_e = StringField('E Time')
    ...
    ratecard = StringField('Rate Card')
...
class TransportsForm(FlaskForm):
    ...
    ways = SelectField('Type', choices=[('One-Way', 'One-Way'), ('Two-Way', 'Two-Way'),('Uber', 'Uber')],default="One-Way")

    uberfees = StringField('Uber Fees')
...
class NotesForm(FlaskForm):
    ...
    note = StringField('Note')
    actual_s_time = StringField('Actual Start time')
    actual_e_time = StringField('Actual End time')
    submit = SubmitField('Submit')
